...
class Crawler:
    def __init__(self):
        # 크롤링을 시작 할 페이지
        self.start_url = "https://www.iloom.com/product/item.do?categoryNo=25"
        self.visited_list = set()
        self.to_visit = set()
        # 상품과 연결될 카테고리
        self.category = ['학생방', '수납장']
        # csv 파일이 저장될 경로
        self.csv_path = "/Users/ckair/Desktop/crawler/csv/"
        # 이미지 파일이 저장될 경로
        self.img_path = '/Users/ckair/Desktop/crawler/pic/'
